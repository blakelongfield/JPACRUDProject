	...
	<c:choose>
		<c:when test="${not empty gym}">
			...
			<form action="update.do" method="POST">
				...
				<p>Gym Member ID: ${gym.id}
				<p>

					ID: <input type="hidden" name="id" value="${gym.id}" /> First
					Name: <input type="text" name="firstName" value="${gym.firstName}" />
					<br> Last Name: <input type="text" name="lastName"
						value="${gym.lastName}" /> <br>

					<!-- add a drop down menu or a jsp to show all classes available -->
					Classes Attended: <input type="text" name="classesAttended"
						value="${gym.classesAttended}" /> <br>

					<!-- add a drop down menu or a jsp to show all equipment -->
					Favorite Equipment: <input type="text" name="favoriteEquipment"
						value="${gym.favoriteEquipment}" /> <br>

					<!-- Error at over 100 and under 16 -->
					Age: <input type="text" name="age" value="${gym.age}" /> <br>
					...
					<br> <input type="submit" value="Submit" value="Enter an ID"/>
			</form>
